...
class SebaCorner:
    ...
    def __init__(self, corner_gen_file: list[str]):
        self.corner_gen_file = corner_gen_file
        self.__corner_generators__ = self.__create_corners_generators__()
    ...
    def __create_corners_generators__(self):
        
        corner_gen_file_copy = self.corner_gen_file.copy()
        ...
        for it_pc, pc in enumerate(parsed_corner):
            ...
            corners.append(Corner(c_type, c_name))
        ...
        for it_pc, pc in enumerate(parsed_corner):
            ...
            corner_generators.append(CornerGenerator(corners, values, grouping))

        return corner_generators
    
    def generate_spice_corners(self):
        result = []
